# 2024-06-19 13:51:41 by RouterOS 7.14.3
# software id = TWIQ-YM3K
#
/interface ethernet
set [ find default-name=ether1 ] comment=WAN disable-running-check=no
set [ find default-name=ether2 ] comment=SW-DIST-Eth2/1 \
...
/interface vrrp
add interface="[10] - VRRP CLIENT" name="VRRP - DHCP CLIENT" priority=254 \
    vrid=10
/ip pool
...
set 0 name=serial0
/ip address
add address=192.168.1.253/24 interface="[10] - VRRP CLIENT" network=\
    192.168.1.0
